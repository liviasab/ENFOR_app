...
var os = /*#__PURE__*/require('os');
var projectDetector = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var currDir, projectFiles, parentFiles, app, packageJson, dependencies, parentPackageJson, workspaces;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          currDir = process.cwd();
          projectFiles = fs.readdirSync(currDir);
          parentFiles = fs.readdirSync(path.resolve(currDir, '..'));
          app = {
            framework: 'Unknown'
          };
          if (projectFiles.includes('package.json')) {
            packageJson = require(currDir + "/package.json");
          ...
          if (parentFiles.includes('package.json')) {
            parentPackageJson = require(path.resolve(currDir, '..', 'package.json'));
            app['meta'] = {};
            workspaces = parentPackageJson.workspaces;
            if (workspaces) {
  ...
  return function projectDetector() {
    return _ref.apply(this, arguments);
  };
}();

exports.projectDetector = projectDetector;
//# sourceMappingURL=ui-project-detector.cjs.development.js.map
